...
import { deletFilesFromCloudinary, emitEvent, uploadFilesToCloudinary } from "../utils/feautures.js";
...
const addMembers=TryCatch(async(req,res,next)=>{
 ...
 if(!members || members.length<1){
  return next(new ErrorHandler("Please Provide a members",400));
 }
 ...
 if(!chat.groupChat) {
  return next(new ErrorHandler("this is not a GroupChat",404));
 }
